...
#  password.
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$+dBqbeMgAhTHBi4aivg6kA$xAvFfwUzEKyr88f0HqvM9PsVAHBm1A90ueRsEaiiMGY'
...
#  Choices: any of ['blake2s', 'sha3_224', 'md5', 'sha224', 'sha3_256', 'sha3_512', 'sha3_384', 'blake2b', 'sha512', 'sha256', 'sha384', 'sha1']
#  Default: 'sha256'
